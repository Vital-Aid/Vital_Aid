        ...
        <table className="w-full border-collapse border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden text-center">
          <thead className="bg-gray-100 dark:bg-gray-700">
            <tr>
              ...
              <th className="border p-3 text-gray-700 dark:text-white">Blood Group</th>
              <th className="border p-3 text-gray-700 dark:text-white">Phone</th>
              <th className="border p-3 text-gray-700 dark:text-white">Gender</th>
              <th className="border p-3 text-gray-700 dark:text-white">Age</th>
              <th className="border p-3 text-gray-700 dark:text-white">Address</th>
          ...
          <tbody>
            {donors.map((donor) => (
              <tr key={donor._id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.name}</td>
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.BloodGroup}</td>
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.Phone}</td>
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.Gender}</td>
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.Age}</td>
                <td className="border p-3 text-gray-700 dark:text-gray-300">{donor.Address}</td>
